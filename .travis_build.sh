...
clang++ -std=c++1y -pthread -g -Wall -Wextra -isystem opencv/build/include -c -o tests/kmosaic.o sources/kmosaic.cpp
...
clang++ -std=c++1y -pthread -g -Wall -Wextra -isystem tests/googletest/googletest/include -isystem opencv/build/include -c -o tests/kmosaic_test.o tests/kmosaic_test.cpp
echo "Done compiling node_test.cpp"
clang++ -std=c++1y -g -Wall -Wextra -o tests/gtest tests/kmosaic.o tests/main.o tests/kmosaic_test.o -pthread -Ltests/ -Lopencv/build/lib -lgtest -lopencv_highgui -lopencv_core -lopencv_imgproc
